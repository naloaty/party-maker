...
def action(on_stop: Optional[NoneAsyncFuncT] = None) -> Callable[[NoneFuncT], Callable[..., ActionContext]]:
    ...
    def outer(func: Callable) -> Callable[..., ActionContext]:
        ...
        def wrapper(*args, **kwargs) -> ActionContext:
            ...
            context = ActionContext(scene.context, func, args, kwargs)
